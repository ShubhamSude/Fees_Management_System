...
public class Update_Fees_Details extends javax.swing.JFrame {
    ...
    public Update_Fees_Details() {
      ...
      public String updateData(){
          ...
          try {
              ...
              PreparedStatement pst=con.prepareStatement("update fees_details set student_name = ?,roll_no = ?,"
                      ...
                      + "dd_no = ?,courses = ?,gstin = ?,total_amount = ?,date = ?,"
      ...
      public void setRecords()
      {
           try {
              ...
              txt_Reciptno.setText(rs.getString("reciept_no"));
              Combo_Payemntmode.setSelectedItem(rs.getString("payment_mode"));
              ...
              txt_recivedfrom.setText(rs.getString("student_name"));
              Date_Chooler.setDate(rs.getDate("date"));
              ...
              txt_SGST.setText(rs.getString("sgst"));
               ...
               txt_totainwords.setText(rs.getString("total_in_words"));
    ...
    private void btn_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_PrintActionPerformed
        if(Validation()==true)
        {
           ...
           {
               JOptionPane.showMessageDialog(this, "record udated Successfully");
